...
class NetworkServiceManager:
    ...
    def __add_security_group_rule_to_prod_db__(self, network_variables:NetworkInfraVariables):

        security_group_id = network_variables.__get_prod_db_security_group_id__()[1:-1][:-1]
        ec2_private_ip = network_variables.__get_ec2_private_ip__()[1:-1][:-1]
        port_range_start = 5432
        protocol = "tcp"
        cidr = ec2_private_ip + "/32"
